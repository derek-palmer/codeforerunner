...
[![Socket Badge](https://badge.socket.dev/npm/package/codeforerunner/0.4.10)](https://socket.dev/npm/package/codeforerunner)
...
jobs:
  doc-check:
    ...
    steps:
      ...
      - uses: derek-palmer/codeforerunner@v0.4.10
        with:
